...
+ **Coreference data generation** : <code> Instuction for program</code> is written in <code>README.md</code> under <code>/Codes/coreference_code</code> directory. Also, there is requirements.txt under <code>/Codes/coreference_code</code> directory.
