...
## Final models can be found at [[THIS LINK]](https://github.com/RMoraffah/NLP-Papers/blob/master/Final_CSE576_Quail_Adversarial.ipynb)
...
+ **Coreference data generation** : <code> Instuction for program</code> is written in <code>README.md</code> under <code>/Codes/coreference_code</code> directory. Also, there is <code> requirements.txt </code> under <code>/Codes/coreference_code </code> directory for dependent libraries in this program.
